function sprite () {
    this.width = 912; // ****el ancho todal de mi spritesheet***
    this.height = 200; // ***el alto de mi spritesheet ***
    this.x = 0;
    this.y = 0;
    this.radius = 114; //***esta medida es lo que mide el ancho de un sprite (un frame del spritesheet)***
    this.vx = 0;
    this.vy = 0;
    this.rotation = 0;
    this.scaleX = 1;
  ...
  sprite.prototype.draw = function (context) {
    ...
    marioImage.src = "mario-sprite.png"; // ***el nombre de tu imagen***
    update();
    context.save();
